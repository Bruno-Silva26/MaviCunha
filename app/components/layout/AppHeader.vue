...
.header--rolado { background: rgba(10, 10, 10, .94); }
.header--aberto { background: rgba(10, 10, 10, .98); }
...
.logo__numero { font-size: 12px; color: var(--amarelo); }
...
.gaveta__link:hover { color: var(--amarelo); }
